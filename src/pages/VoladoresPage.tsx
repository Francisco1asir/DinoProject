...
import { getDinosaurios, getDinosauriosVoladores, newDino } from '../firebase/FBdinos'
...
export const VoladoresPage = () => {
  const [dinosaurios, setDinos] = useState<IDinos[]>([])
  useEffect(() => {
    getDinosauriosVoladores()
      .then(res => {
        console.log(...res)
        setDinos([...res])
      });
  ...
  return (
    <>
      <ReactPlayer
        ...
        height='100%'
      />
      <h1 id='tittle-home'>Dinosaurios Voladores</h1>
